...
class ProductImagesController extends Controller {
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('ProductImages');
    ...
    public function actionAdmin() {
        $model = new ProductImages('search');
        $model->unsetAttributes();  // clear any default values
        if (isset($_GET['ProductImages']))
            $model->attributes = $_GET['ProductImages'];
     ...
     * @param ProductImages $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'product-images-form') {
