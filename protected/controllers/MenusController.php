...
class MenusController extends Controller {
    ...
    public function actionInstallMenus() {
        ...
        $ary[] = array("id" => "5", "pid" => "2", "root_parent" => "2", "controller" => "categories", "action" => "createParent", "default_title" => "Create Category", "user_title" => "Create Category", "is_assigned" => "Yes", "min_permission" => "View", "weight" => "2");
        $ary[] = array("id" => "6", "pid" => "2", "root_parent" => "2", "controller" => "categories", "action" => "indexParent", "default_title" => "List Category", "user_title" => "List Category", "is_assigned" => "Yes", "min_permission" => "View", "weight" => "2");
        /*         * ************************** for Rental Product Menu ********************************** */
        $ary[] = array("id" => "7", "pid" => "0", "root_parent" => "7", "controller" => "products", "action" => "index", "default_title" => "Rental Product", "user_title" => "Rental Product", "is_assigned" => "Yes", "min_permission" => "View", "weight" => "3");
        $ary[] = array("id" => "8", "pid" => "7", "root_parent" => "7", "controller" => "products", "action" => "index", "default_title" => "List Rental Product", "user_title" => "List Rental Product", "is_assigned" => "Yes", "min_permission" => "View", "weight" => "0");
        $ary[] = array("id" => "9", "pid" => "7", "root_parent" => "7", "controller" => "products", "action" => "create", "default_title" => "Create Rental Product", "user_title" => "Create Rental Product", "is_assigned" => "Yes", "min_permission" => "View", "weight" => "2");
