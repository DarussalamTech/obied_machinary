...
class MenusController extends Controller {
    ...
    public function actionInstallMenus() {
        ...
        $ary[] = array("id" => "10", "pid" => "7", "root_parent" => "7", "controller" => "products", "action" => "indexTrading", "default_title" => "List Trading Product", "user_title" => "List Trading Product", "is_assigned" => "Yes", "min_permission" => "View", "weight" => "0");
